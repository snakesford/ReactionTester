  ...
  function seededDelayMs() {
    // deterministic delay range 1.0s–3.5s
  ...
  copyLinkBtn.addEventListener("click", async () => {
    ...
    try {
      ...
      alert("Couldn’t copy. Here’s the link:\n" + url);
    }
  });
  ...
  function updateRunUI() {
    ...
    lastTimeEl.textContent  = `Last: ${attempts.length ? attempts[attempts.length-1] + " ms" : "—"}`;
  ...
  function setState(newState) {
    ...
    if (state === "waiting") {
      ...
      sub.textContent = "Don’t click early!";
  ...
  function finishRun() {
    ...
    sub.textContent = "Nice. Saving to leaderboard…";
